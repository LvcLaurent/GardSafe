...
import fr.lsi.zacta.domain.common.entity.AbstractBaseEntity;
import fr.lsi.zacta.domain.common.event.Event;
import fr.lsi.zacta.domain.common.event.EventAware;
import fr.lsi.zacta.domain.exception.LoginException;
...
public final class User extends AbstractBaseEntity implements EventAware {
  ...
  public static class Builder {
    ...
    public Builder pseudo(final String pseudo) throws LoginException {
      if ((pseudo == null) || pseudo.isEmpty() || (pseudo.length() < 3)) {
        throw new LoginException(ErrorConstant.MESSAGE_USER_ERREUR,
    ...
    public Builder birthDate(final String birthDate) throws LoginException {
      if ((birthDate == null) || birthDate.isEmpty()
          || !birthDate.matches("[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]")) {
        throw new LoginException(ErrorConstant.MESSAGE_USER_ERREUR,
    ...
    public Builder phone(final String phone) throws LoginException {
      ...
      if ((phone != null) && !phone.isEmpty()) {
        ...
        if (!phoneSave.matches("[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]")) {
          throw new LoginException(ErrorConstant.MESSAGE_USER_ERREUR,
    ...
    public Builder mail(final String mail) throws LoginException {
      if ((mail == null) || mail.isEmpty() || !mail.matches("^(.+)@(.+)$")) {
